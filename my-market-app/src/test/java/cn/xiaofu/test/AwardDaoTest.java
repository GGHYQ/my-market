...
import cn.xiaofu.infrastructure.dao.IAwardDao;
...
public class AwardDaoTest {
    ...
    @Test
    public void testAwardList(){
        List<AwardPO> awardPOS = iAwardDao.queryList();
        log.info("awardPOS:{}", JSON.toJSONString(awardPOS));
    }
}
